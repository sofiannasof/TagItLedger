...
RUN echo 'nxt.addOns=nxt.addons.JPLSnapshot' >> /nxt/conf/nxt.properties
RUN echo 'nxt.adminPassword=123456' >> /nxt/conf/nxt.properties
RUN echo 'nxt.defaultPeers=172.18.0.1;172.18.0.2;172.18.0.3;172.18.0.4' >> /nxt/conf/nxt.properties
